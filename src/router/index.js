...
export const constantRoutes = [
...

  {
    ...
    name: 'DSManager',
    meta: { title: 'DSManager', icon: 'table' },
    children: [
      {
        path: 'list',
        name: 'DSList',
...

  {
    ...
    redirect: '/task/list',
    name: 'TaskManager',
    meta: { title: 'TaskManager', icon: 'table' },
    children: [
      {
        path: 'list',
        name: 'TaskList',
...

  {
    ...
    redirect: '/log/list',
    name: 'LogManager',
    meta: { title: 'LogManager', icon: 'table' },
    children: [
      {
        path: 'list',
        name: 'LogList',
      ...
      },
      {
        ...
        name: 'LogDashboard',
        component: () => import('@/views/dashboard/index'),
        meta: { title: 'LogDashboard', icon: 'dashboard' }
      }
    ]
  },
